...
class Command(BaseCommand):
    ...
    def handle(self,*args,**kwargs):
        users=UserProfile.objects.filter(userid=None).values_list('reg_number','user__email','user__first_name','user__last_name',flat=False)
        ...
        if users.count()>0:
            ...
            try:
                ...
                self.stdout.write(self.style.SUCCESS('Sent email to all participants'))
