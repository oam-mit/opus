...
DAYS={
    'day1':{
        ...
        'end_question':1,
        'branches':[],
        'date':datetime.datetime(2020,10,27,tzinfo=tz('Asia/Kolkata')),
    },
   'day2':{
        'start_question':2,
        'end_question':2,
        'branches':[],
        'date':datetime.datetime(2020,10,28,tzinfo=tz('Asia/Kolkata')),
    },
    'day3':{
        'start_question':3,
        'end_question':3,
        'branches':[],
        'date':datetime.datetime(2020,10,29,tzinfo=tz('Asia/Kolkata')),
    },
    'day4':{
        'start_question':4,
        'end_question':5,
